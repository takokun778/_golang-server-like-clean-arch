...
func (m *TemplateMutation) SetSample(s string) {
	m.sample = &s
}

// Sample returns the value of the "sample" field in the mutation.
func (m *TemplateMutation) Sample() (r string, exists bool) {
	v := m.sample
	if v == nil {
		return
	}
...
// OldSample returns the old "sample" field's value of the Template entity.
// If the Template object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TemplateMutation) OldSample(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldSample is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, fmt.Errorf("OldSample requires an ID field in the mutation")
	}
...
func (m *TemplateMutation) ResetSample() {
	m.sample = nil
}
...
// OldCreatedAt returns the old "createdAt" field's value of the Template entity.
// If the Template object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
// OldUpdatedAt returns the old "updatedAt" field's value of the Template entity.
// If the Template object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
func (m *TemplateMutation) Fields() []string {
	...
	if m.sample != nil {
		fields = append(fields, template.FieldSample)
	}
	if m.createdAt != nil {
